  ...
  return (
    <form className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_300px]" onSubmit={async (event) => {
      ...
      <aside className="space-y-5 border border-[var(--line)] bg-[var(--surface)] p-5">
        ...
        {selected?.controls.guidance && guidanceLocked && <p className="-mt-3 text-[0.68rem] leading-4 text-[var(--muted)]">Fixed at {lockedGuidance} for this model&apos;s distilled inference.</p>}
