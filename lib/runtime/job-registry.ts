...
import type { GenerationSummary, JobStatus, RuntimeJob, WorkflowType } from "@/lib/types";
...
export function createJob(input: { workflowType: WorkflowType; modelKey: string; prompt: string; requestSnapshot: JobRequestSnapshot; summary?: GenerationSummary }) {
